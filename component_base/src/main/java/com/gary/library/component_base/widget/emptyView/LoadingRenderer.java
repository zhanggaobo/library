package com.gary.library.component_base.widget.emptyView;
...
public abstract class LoadingRenderer {
    ...
    private void initParams(Context context) {
        mWidth = ConvertUtils.dip2px(context, DEFAULT_SIZE);
        mHeight = ConvertUtils.dip2px(context, DEFAULT_SIZE);
